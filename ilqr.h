...
void iterativeLQR(const size_t& ell,
                  ...
                  std::function<Vector<xDim>(const Vector<xDim>&, const Vector<uDim>&)> g,
                  //void (*quadratizeFinalCost)(const Vector<xDim>&, SymmetricMatrix<xDim>&, Vector<xDim>&, const size_t&),
                  std::function<void(const Vector<xDim>&, SymmetricMatrix<xDim>&, Vector<xDim>&, const size_t&)> quadratizeFinalCost,
                  //double (*cell)(const Vector<xDim>&),
                  std::function<double(const Vector<xDim>&)> cell,
                  ...
                  std::function<void(const Vector<xDim>&, const Vector<uDim>&, const size_t&, Matrix<uDim, xDim>&, SymmetricMatrix<xDim>&, SymmetricMatrix<uDim>&, Vector<xDim>&, Vector<uDim>&, const size_t&)> quadratizeCost,
                  //double (*ct)(const Vector<xDim>&, const Vector<uDim>&, const size_t&),
                  std::function<double(const Vector<xDim>&, const Vector<uDim>&, const size_t&)> ct,
